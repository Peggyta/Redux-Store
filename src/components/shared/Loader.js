...
const Loader = () => {
    return (     
    <div role="status" class="max-w-sm p-4 mb-4 border border-grey-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700">
        ...
        <div class="h-2.5 bg-grey rounded-full dark:bg-black w-48 mb-4"></div>
